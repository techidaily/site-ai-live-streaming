...
// ------------------------------------------------------------------------------------------- 以下内容需要自己替换
const subSiteAuthor = 'Jeff';
const subSiteKeywords = `live streaming,live selling,online live selling` + ','; // 关键字，多个关键字用逗号分隔
const indexNowKey = 'cb144f5f351a42df90dcb761371c0257'; // 替换为你的API密钥
